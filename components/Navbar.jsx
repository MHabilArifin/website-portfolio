        ...
        <div className={nav ? " fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ecf0f3] p-10 ease-in duration-500" : "fixed left-[-100%] top-0 p-10 ease-in duration-500"}>
          <div>
            ...
            <div className="border-b border-gray-300 my-4">
              <p className="w-[85%] md:w-[90%] py-4">A Back-End Developer </p>
            </div>
          </div>
          <div className="py-4 flex flex-col">
            ...
            <div className="pt-40">
              <p className="uppercase tracking-widest text-[#5651e5]">A journey to become a better</p>
              <div className="flex items-center justify-between my-4 w-full sm:w-[80%]">
                <a href="www.linkedin.com/in/mhabilarifin-58188822a" target="_blank" rel="noreferrer">
                  <div className="rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer hover:scale-105 ease-in duration-300">
                    <FaLinkedinIn />
                  </div>
                </a>
                <a href="https://github.com/MHabilArifin" target="_blank" rel="noreferrer">
                  <div className="rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer hover:scale-105 ease-in duration-300">
                    <FaGithub />
                  </div>
                </a>

    ...
    <div className="w-full md:h h-screen p-2 flex items-center py-16">
      <div className="max-w-[1240px] m-auto md:grid grid-cils-3">
        <div className="col-span-2">
          ...
          <p className="py-2 text-gray-600">Hi, I'm Muhammad Habil Arifin. Students who have not graduated majoring in Informatics Engineering from the University of the Informatics Institute and Darmajaya Business School.</p>
      ...
      <div className="w-full h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center justify-center p-4 hover:scale-105 ease-in duration-300">
        <img className="rounded-xl" src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2072&q=80" alt="/" />
      </div>
    </div>
  );
};
